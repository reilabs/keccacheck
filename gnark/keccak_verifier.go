...
func VerifyKeccakF(api frontend.API, num_vars int, input, output, proof []frontend.Variable, r_0 frontend.Variable) {
	...
	r[0] = r_0
	for i := range num_vars - 1 {
		r[i+1] = verifier.Generate(api)
	}
